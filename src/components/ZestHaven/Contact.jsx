  ...
  return (
    <section id="contact" aria-label="Contact us" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <ScrollReveal animation="fadeUp" className="mx-auto max-w-lg text-center">
          <SectionLabel>
        ...
        {state === "sent" ? (
          <motion.div
            ...
            className="mx-auto mt-12 max-w-md rounded-2xl border border-gold/40 bg-background/60 p-8 text-center"
            role="status"
            aria-live="polite"
          >
