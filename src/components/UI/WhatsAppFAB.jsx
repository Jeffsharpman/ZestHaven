function WhatsAppFAB() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-110 hover:shadow-xl"
    >
      <svg
        viewBox="0 0 24 24"
      ...
      <span className="absolute right-16 whitespace-nowrap rounded-full border border-border bg-background/90 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.2em] text-foreground shadow-lg backdrop-blur opacity-0 transition-opacity group-hover:opacity-100">
